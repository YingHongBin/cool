...
import com.nus.cohana.core.cohort.filter.RangeFieldFilter;
import com.nus.cohana.core.cohort.query.FieldSet;
...
public class IcebergSelection {
    ...
    public void process(MetaChunkRS metaChunk) {
        ...
        MetaFieldRS timeField = metaChunk.getMetaField(this.tableSchema.getActionTimeField(), FieldType.ActionTime);
